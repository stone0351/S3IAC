...
# Route53 configuration has been manually set up and is no longer managed by Terraform

# CloudFront distribution has been manually set up and is no longer managed by Terraform
